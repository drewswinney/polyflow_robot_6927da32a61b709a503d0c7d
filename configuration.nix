...
let
  user      = "admin";
  password  = "password";
  hostname  = "6927da32a61b709a503d0c7d";
  homeDir   = "/home/${user}";
...
in
{
  ...
  hardware.deviceTree = {
    enable = true; # provided by nixos-hardware/raspberry-pi/4; add our overlay here
          ...
          / {
            ...
            fragment@0 {
              ...
              __overlay__ {
                ...
                # CS_0 on SPI0: CE0 -> GPIO8, CE1 -> GPIO7 (matches table: 8/7)
            ...
            fragment@4 {
              ...
              __overlay__ {
                ...
                # CS_1 on SPI1: CE0 -> GPIO18, CE1 -> GPIO17, CE2 -> GPIO16 (per table: 18/17/16/26)
                cs-gpios = <&gpio 18 GPIO_ACTIVE_LOW>, <&gpio 17 GPIO_ACTIVE_LOW>, <&gpio 16 GPIO_ACTIVE_LOW>;
                can1: mcp251xfd@0 {
                  compatible = "microchip,mcp251xfd";
                  reg = <0>;
                  spi-max-frequency = <${toString canSpiMaxFrequency}>;
                  interrupt-parent = <&gpio>;
                  interrupts = <${toString can1InterruptGpio} IRQ_TYPE_LEVEL_LOW>;
                  clocks = <&can1_osc>;
                  clock-names = "osc";
                  status = "okay";
                };
